 ...
 * stamp; a sticker is fit to 80% of the stamp with its transparency kept and its cream die-cut edge already in
 * the derivative it is drawn from (3.28), and falls back to nothing, silently, if that cannot load (3.9). No mark
 * renders nothing at all: callers must not render this component for a blank mark.
 *
